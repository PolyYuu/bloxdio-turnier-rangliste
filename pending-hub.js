(() => {
  ...
  function installHeader(){
    $('#hubPendingHeaderStatus')?.remove();const account=$('#loginDemoButton');if(!account)return;account.removeAttribute('data-i18n');account.textContent=pendingName();account.classList.add('is-account');
