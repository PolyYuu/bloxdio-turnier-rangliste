...
- 40% placement/opponent strength
- 55% SG points
- 5% dominance
...
The move from the provisional 55/40/5 split to 40/55/5 is deliberate: on the real 22.08 Cup data it makes the accumulated per-round rating better reflect the actual Cup points table without adding a separate end-of-Cup placement bonus.
...
- 9-team Cup #1 round 1: four 0-point teams are about -20 each, not -35/-40
- equal-rating normal 9-team wins remain around +47 to +49 depending on the small dominance modifier
- the real Cup #1 accumulated team ordering is Orange #1, Dark Green narrowly #2, Pink #3, Yellow #4 without using an end-of-Cup ranking bonus
